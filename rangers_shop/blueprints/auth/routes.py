...
# internal imports
from rangers_shop.models import User, db  # grabbing our class so we can instantiate User objects and database
...
def signup():
    ...
    return render_template('sign_up.html', form=registerform)  # passing registerform object as form in html
